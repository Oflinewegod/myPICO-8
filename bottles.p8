...
function updatecursor()
	boundcursor()
	spr(curs.f,curs.x,curs.y-3,2,1)
	curs.f+=2
end

function drawmenu(x1,y1,x2,y2,col)
	rect(x1, y1, x2, y2, col)
	rectfill(x1+1,y1+1,x2-1,y2-1,7)
end

function mainmenu()
 print("generic bottle game",0,0,7)
	drawmenu(32,32,96,96,6)
	for i=1,#menu do
		print(menu[i],34,32+16*i,0)
	end
end
-->8
--game?
...

...

